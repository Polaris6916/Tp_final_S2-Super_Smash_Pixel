    ...
    , m_delayCrystal(-1.f)
{
    ...
    scene->AddSimulationSystem(std::make_shared<LeafRangerSystem>(scene));
    ...
    scene->AddSimulationSystem(std::make_shared<CrystalSystem>(scene));
	scene->AddSimulationSystem(std::make_shared<ArrowSystem>(scene));
    scene->AddSimulationSystem(std::make_shared<KnifeSystem>(scene));
    // Other
    ...
    imGuiManager->AddTag(std::make_unique<ImGuiTag<LeafRangerTag>>("Leaf Ranger tag"));
    ...
    imGuiManager->AddTag(std::make_unique<ImGuiTag<BombTag>>("Crystal tag"));
	imGuiManager->AddTag(std::make_unique<ImGuiTag<ArrowTag>>("Arrow tag"));
    //--------------------------------------------------------------------------
    // Création du niveau
    ...
    {
    case StageConfig::Frequency::RARELY:
        m_delayBomb = random::RangeF(15.f, 30.f);
        break;
    case StageConfig::Frequency::SOMETIMES:
        m_delayBomb = random::RangeF(5.f, 15.f);
        break;
    case StageConfig::Frequency::OFTEN:
        m_delayBomb = random::RangeF(1.f, 3.f);
        break;
    default:
        break;
    }

    switch (stageConfig.crystalFrequency)
    {
    case StageConfig::Frequency::RARELY:
        m_delayCrystal = random::RangeF(30.f, 40.f);
        break;
    case StageConfig::Frequency::SOMETIMES:
        m_delayCrystal = random::RangeF(20.f, 30.f);
        break;
    case StageConfig::Frequency::OFTEN:
        m_delayCrystal = random::RangeF(10.f, 20.f);
        break;
    default:
        break;
    }
...
void StageManager::OnSceneFixedUpdate()
{
    ...
    if (m_state == State::FIGHT)
    {
        ...
        if (stageConfig.crystalFrequency != StageConfig::Frequency::NEVER)
        {
            m_delayCrystal -= scene->GetDelta();
            if (m_delayCrystal < 0.f)
            {
                AddCrystal();
            }
        }
...
void StageManager::AddPotion()
{
    ...
    {
    case StageConfig::Frequency::RARELY:
        m_delayPotion = random::RangeF(30.f, 40.f);
        break;
    case StageConfig::Frequency::SOMETIMES:
        m_delayPotion = random::RangeF(20.f, 30.f);
        break;
...
void StageManager::AddCrystal()
{
    ...
    b2Vec2 position = { random::RangeF(-7.f, 7.f), 10.f };
    b2Vec2 velocity = { random::RangeF(-3.f, 3.f), 0.f };
    CrystalCommand::Create(registry, registry.create(), scene, position, velocity);

    m_delayCrystal = random::RangeF(10.f, 15.f);
    ...
    case StageConfig::Frequency::SOMETIMES:
        ...
        break;
    case StageConfig::Frequency::OFTEN:
        m_delayCrystal = random::RangeF(5.f, 10.f);
        break;
    default:
        break;
    }
...
void StageManager::InitStarFields()
{
    ...
    StarFieldsPlatformCommand::Create(registry, registry.create(), scene, b2Vec2{ 7.0f, 3.f }, 0);
