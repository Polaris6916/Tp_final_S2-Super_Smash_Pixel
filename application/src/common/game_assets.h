...
namespace assets
{
    ...
    void InitAnimations_LeafRanger(AssetManager* assets, SpriteAnimManager* animManager);
    void InitAnimations_Metal_Bladekeeper(AssetManager* assets, SpriteAnimManager* animManager);
...
enum SoundID : uint32_t
{
	...
	SFX_ATTACK_LEAF_RANGER, SFX_ATTACK_METAL_BLADEKEEPER
};
...
enum SheetID : uint32_t
{
    ...
    SHEET_LEAF_RANGER_0, SHEET_LEAF_RANGER_1,
	SHEET_METAL_BLADEKEEPER_0, SHEET_METAL_BLADEKEEPER_1,
    SHEET_SHIELD,

    SHEET_TILESET_STAR_FIELDS,
    SHEET_UI, SHEET_UI_STAGE,

    SHEET_ITEM_POTION, SHEET_ITEM_BOMB, SHEET_ITEM_CRYSTAL,
	...
	SHEET_ATTACK_LEAF_RANGER, SHEET_ATTACK_METAL_BLADEKEEPER,
};
...
enum class AnimType : uint32_t
{
    ...
    SHIELD,
    //
    POTION, BOMB_NORMAL, BOMB_DANGER, CRYSTAL,
    //
    ...
    HEAL, EXPLOSION,
    //
    ARROW_1, ARROW_2_DEBUT, ARROW_2_FIN, ARROW_3, ARROW_SMASH, ARROW_AIR,
	KNIFE, BLADE_1, BLADE_2, BLADE_3, BLADE_4, BLADE_5
};
